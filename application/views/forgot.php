...
<head>
    ...
    <title>SeekHostel - Password recovery </title>
</head>
<body>
<div class="content">
...
<div style="margin-top: 100px; margin-bottom: 200px;background-color: black;color: white; width: 500px; height: auto;
    ...
    <form method="POST">
    <b class="fa fa-user">  Enter Your Registered email Address</b> <br> 
    <input style="width: 350px" type="text" name="email" placeholder="Enter Email" value="<?= set_value('email') ?>" required> </br>
    <font style="color:red"><?php echo  form_error('email'); ?> </font> <p>
